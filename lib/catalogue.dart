...
class CataloguePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<Map<String, dynamic>> categories = [
        ...
        'products': [
          {
            ...
            'image': 'https://cdn.pixabay.com/photo/2017/11/27/21/31/computer-2982270_640.jpg'
          },
          {
            'name': 'Smartphone',
            'price': '\$850',
            ...
            'image': 'https://cdn.pixabay.com/photo/2017/04/03/15/52/mobile-phone-2198770_640.png'
          },
          {
            'name': 'Headphones',
            'price': '\$250',
          ...
          },
          {
            ...
            'image': 'https://cdn.pixabay.com/photo/2018/10/02/11/44/huawei-3718609_640.jpg'
          },
        ],
      },
      {
        'name': 'Clothing',
        'image': 'https://cdn.pixabay.com/photo/2019/03/01/02/48/store-4027251_640.jpg',
        'products': [
          {
            'name': 'T-shirt',
            'price': '\$200',
            ...
            'image': 'https://cdn.pixabay.com/photo/2019/07/27/21/42/t-shirt-4367577_640.jpg'
          },
          {
            'name': 'Jeans',
            'price': '\$250',
          ...
          },
          {
            ...
            'image': 'https://cdn.pixabay.com/photo/2015/07/12/19/23/clothing-842338_640.jpg'
          },
          {
            'name': 'Scarfs',
            'price': '\$150',
            ...
            'image': 'https://cdn.pixabay.com/photo/2017/08/20/14/02/colorful-scarves-2661828_640.jpg'
          },
          {
            'name': 'Hats',
            'price': '\$250',
      ...
      {
        'name': 'Home & Kitchen',
        'image': 'https://cdn.pixabay.com/photo/2019/09/18/17/19/village-shop-4487285_640.jpg',
        'products': [
          {
            'name': 'Blender',
            'price': '\$300',
